...
const TodoItem = ({ todo }) => {
  ...
  const categoryColor =
    categories.find(c => c.name === todo.category)?.color || '#6366f1';
  ...
  return (
    <motion.div
      layout
      className="flex items-center gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-md border-l-4"
    ...
    >
      ...
      <div className="flex gap-1">
        ...
        <button onClick={() => archiveTodo(todo._id)}>
