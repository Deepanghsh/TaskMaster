        ...
        <div className={`min-h-screen flex items-center justify-center p-4 ${
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                >
                    ...
                    {generalError && (
                        <div className="mb-4 p-4 bg-red-100 dark:bg-red-900/30 border border-red-300 dark:border-red-800 text-red-700 dark:text-red-400 rounded-xl text-sm flex items-center gap-2">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={!isPasswordValid()} // Disable if password isn't valid
